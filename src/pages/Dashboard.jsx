...
export default function Dashboard() {
  ...
  const MODULES = useMemo(() => [
    ...
    { Icon:MapPin,        color:"#ea580c", bg:"#ffedd5", label:"Rastreamento",           desc:"Posição em tempo real (SASCAR/VDO)", module:null,          link:null, stat: null },
    { Icon:UserCog,       color:"#475569", bg:"#f1f5f9", label:"Usuários",               desc:"Contas e acessos",                   module:null,          link:"/usuarios", adminOnly:true, stat: null },
    { Icon:ShieldCheck,   color:"#0f766e", bg:"#ccfbf1", label:"Permissões",             desc:"Configurar acessos por cargo",       module:null,          link:"/permissoes", adminOnly:true, stat: null },
  ], [kpi]);

  const visibleModules = useMemo(() =>
    MODULES.filter(m => m.adminOnly ? isAdmin : (m.module ? canView(m.module) : isAdmin)),
    [MODULES, isAdmin, canView]
  );
